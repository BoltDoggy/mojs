...
var Zigzag;
var extend$2 = function (child, parent) {
  for (var key in parent) {
...
var Rect;
var extend$3 = function (child, parent) {
  for (var key in parent) {
...
var Polygon;
var extend$4 = function (child, parent) {
	for (var key in parent) {
...
var Cross;
var extend$5 = function (child, parent) {
  for (var key in parent) {
...
var Equal;
var extend$6 = function (child, parent) {
  for (var key in parent) {
...
class Html extends Thenable {
  ...
  */
  _drawTransform() {
    const p = this._props;
    const string = !this._is3d ? `translate(${ p.x }, ${ p.y })
          rotate(${ p.angleZ }deg)
  ...
  */
  _extendDefaults() {
    ...
    // copy the options
    let o = babelHelpers.extends({}, this._o);
  ...
  _mergeThenProperty(key, startValue, endValue) {
    ...
    if (!h.isTweenProp(key) && !this._nonMergeProps[key] && !isBoolean) {
      ...
      if (this._isDelta(endValue)) {
        ...
        return babelHelpers.extends({}, result, TWEEN_PROPS);
      } else {
        var parsedEndValue = this._parsePreArrayProperty(key, endValue);
        // if end value is not delta - merge with start value
        if (this._isDelta(startValue)) {
          ...
          return babelHelpers.extends({ [startValue]: parsedEndValue }, TWEEN_PROPS);
        }
      }
      // copy the tween values unattended
    } else {
...
class Stagger extends Tuneable {
  ...
  */
  _getOptionByIndex(i, store) {
    var options = {};
    Object.keys(store).forEach(key => options[key] = this._getOptionByMod(key, i, store));
    return options;
  }
  /*
...
var mojs$1 = {
  ...
  Tween, Timeline, Tweenable, Thenable, Tunable: Tuneable, Module,
  tweener: t, easing, shapesMap, _pool: { Delta, Deltas }
};
