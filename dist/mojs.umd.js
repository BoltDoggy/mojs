...
var Helpers = function () {
  ...
  Helpers.prototype.style = function (el, name, value) {
    ...
    if ((typeof name === 'undefined' ? 'undefined' : _typeof(name)) === 'object') {
      ...
      while (len--) {
        key = keys[len];
        value = name[key];
        results.push(this$1.setPrefixedStyle(el, key, value));
      }
      return results;
    } else {
  ...
  Helpers.prototype.calcArrDelta = function (arr1, arr2) {
    ...
    for (i = j = 0, len1 = arr1.length; j < len1; i = ++j) {
      num = arr1[i];
      delta[i] = this$1.parseUnit("" + (arr2[i].value - arr1[i].value) + arr2[i].unit);
    }
    return delta;
  };
  ...
  Helpers.prototype.normDashArrays = function (arr1, arr2) {
    ...
    if (arr1Len > arr2Len) {
      ...
      for (i = j = 0, ref = lenDiff; 0 <= ref ? j < ref : j > ref; i = 0 <= ref ? ++j : --j) {
        currItem = i + startI;
        arr2.push(this$1.parseUnit("0" + arr1[currItem].unit));
      }
      ...
      for (i = k = 0, ref1 = lenDiff; 0 <= ref1 ? k < ref1 : k > ref1; i = 0 <= ref1 ? ++k : --k) {
        currItem = i + startI;
        arr1.push(this$1.parseUnit("0" + arr2[currItem].unit));
      }
    }
    return [arr1, arr2];
  };
  ...
  Helpers.prototype.parseDelta = function (key, value, index) {
    ...
    if (isNaN(parseFloat(start)) && !start.match(/rand\(/) && !start.match(/stagger\(/)) {
      ...
      for (i = j = 0, len1 = startArr.length; j < len1; i = ++j) {
        ...
        this$1.mergeUnits(start, end, key);
      }
      delta = {
        type: 'array',
        name: key,
  ...
  Helpers.prototype.isDOM = function (o) {
    ...
    return (typeof o === 'undefined' ? 'undefined' : _typeof(o)) === 'object' && isNode;
  };
  ...
  Helpers.prototype.delta = function (start, end) {
    ...
    type1 = typeof start === 'undefined' ? 'undefined' : _typeof(start);
    type2 = typeof end === 'undefined' ? 'undefined' : _typeof(end);
  ...
  createClass(Module, [{
    ...
    */
    ...
    value: function _setProp(attr, value) {
      ...
      if ((typeof attr === 'undefined' ? 'undefined' : _typeof(attr)) === 'object') {
        for (var key in attr) {
          this$1._assignProp(key, attr[key]);
        }
      } else {
    ...
    */
    ...
    value: function _getDelta(key, optionsValue) {
      ...
      var deltaEnd = _typeof(delta.end) === 'object' ? delta.end.value === 0 ? 0 : delta.end.string : delta.end;
    ...
    */
    ...
    value: function _extendDefaults() {
      ...
      for (var key in this._defaults) {
        ...
        var value = this$1._o[key] != null ? this$1._o[key] : this$1._defaults[key];
        // parse option
        this$1._parseOption(key, value);
      }
    }
    /*
    ...
    */
    ...
    value: function _tuneNewOptions(o) {
      ...
      for (var key in o) {
        ...
        o && delete this$1._deltas[key];
        // rewrite _o record
        this$1._o[key] = o[key];
        // save the options to _props
        this$1._parseOption(key, o[key]);
      }
    }
    /*
    ...
    */
    ...
    value: function _parseDeltaValues(name, delta) {
      ...
      for (var key in delta) {
        ...
        var newEnd = this$1._parsePreArrayProperty(name, value);
        d[this$1._parsePreArrayProperty(name, key)] = newEnd;
      }
      return d;
    }
    /*
    ...
    value: function _calcCurrentProps(easedProgress, p) {
      ...
      for (var key in this._deltas) {
        ...
        if (value.type === 'array') {
          ...
          if (h.isArray(this$1._props[key])) {
            arr = this$1._props[key];
            arr.length = 0;
          } else {
            arr = [];
          }
          ...
          this$1._props[key] = arr;
        } else if (value.type === 'number') {
          this$1._props[key] = !isCurve ? value.start + ep * value.delta : value.curve(p) * (value.start + p * value.delta);
        } else if (value.type === 'unit') {
          var currentValue = !isCurve ? value.start.value + ep * value.delta : value.curve(p) * (value.start.value + p * value.delta);

          this$1._props[key] = '' + currentValue + value.end.unit;
          ...
          this$1._props[key] = 'rgba(' + r + ',' + g + ',' + b + ',' + a + ')';
        }
      }
    }
    /*
...
var Bit = function (_Module) {
  inherits(Bit, _Module);

  function Bit() {
    classCallCheck(this, Bit);
    return possibleConstructorReturn(this, (Bit.__proto__ || Object.getPrototypeOf(Bit)).apply(this, arguments));
  }
  ...
  createClass(Bit, [{
    ...
    */
    ...
    value: function _draw() {
      ...
      while (len--) {
        var name = this$1._drawMap[len];
        switch (name) {
          case 'stroke-dasharray':
          case 'stroke-dashoffset':
            this$1.castStrokeDash(name);
        }
        this$1._setAttrIfChanged(name, this$1._props[name]);
      }
    ...
    value: function castStrokeDash(name) {
      ...
      if (h.isArray(p[name])) {
        ...
        for (var i = 0; i < p[name].length; i++) {
          var dash = p[name][i],
              cast = dash.unit === '%' ? this$1.castPercent(dash.value) : dash.value;
          stroke += cast + ' ';
        }
    ...
    */
    ...
    value: function _getPointsPerimiter(points) {
      ...
      for (var i = 1; i < points.length; i++) {
        sum += this$1._pointsDelta(points[i - 1], points[i]);
      }
...
var Custom = function (_Bit) {
  inherits(Custom, _Bit);

  function Custom() {
    classCallCheck(this, Custom);
    return possibleConstructorReturn(this, (Custom.__proto__ || Object.getPrototypeOf(Custom)).apply(this, arguments));
  }
  ...
  createClass(Custom, [{
    ...
    */
    value: function _declareDefaults() {
      ...
      get(Custom.prototype.__proto__ || Object.getPrototypeOf(Custom.prototype), '_declareDefaults', this).call(this);
      ...
      for (var i = 0; i < this._drawMap.length; i++) {
        if (this$1._drawMap[i] === 'stroke-width') {
          this$1._drawMap.splice(i, 1);
        }
      }
    }
    /*
    ...
    */
    ...
    value: function _draw() {
      ...
      get(Custom.prototype.__proto__ || Object.getPrototypeOf(Custom.prototype), '_draw', this).call(this);
    }
    /*
      Method for initial render of the shape.
      @private
	...
	Polygon.prototype._draw = function () {
		...
		if (!(isRadiusX && isRadiusY && isPoints)) {
			...
			for (i = j = 0, ref = this._props.points; 0 <= ref ? j < ref : j > ref; i = 0 <= ref ? ++j : --j) {
				this$1._radialPoints.push(h.getRadialPoint({
					radius: this$1._props.radius,
					radiusX: this$1._props.radiusX,
					radiusY: this$1._props.radiusY,
					angle: i * step,
					center: {
						x: p.width / 2,
						y: p.height / 2
...
var Curve = function (_Bit) {
  ...
  function Curve() {
    ...
    return possibleConstructorReturn(this, (Curve.__proto__ || Object.getPrototypeOf(Curve)).apply(this, arguments));
  }
  ...
  createClass(Curve, [{
    ...
    */
    value: function _declareDefaults() {
      get(Curve.prototype.__proto__ || Object.getPrototypeOf(Curve.prototype), '_declareDefaults', this).call(this);
      this._defaults.tag = 'path';
    }
    /*
    ...
    */
    ...
    key: '_draw',
    value: function _draw() {
      get(Curve.prototype.__proto__ || Object.getPrototypeOf(Curve.prototype), '_draw', this).call(this);
      var p = this._props;
...
var indexOf = [].indexOf || function (item) {
  ...
  for (var i = 0, l = this.length; i < l; i++) {
    if (i in this$1 && this$1[i] === item) { return i; }
  }return -1;
};
/**
  ...
  BezierEasing.prototype.generate = function (mX1, mY1, mX2, mY2) {
    ...
    for (i = j = 0; j < 4; i = ++j) {
      ...
      if (typeof arg !== "number" || isNaN(arg) || !isFinite(arg)) {
        return this$1.error('Bezier function expects 4 arguments');
      }
    }
...
var PathEasing = function () {
  ...
  PathEasing.prototype._preSample = function () {
    ...
    for (i = j = 0, ref = this._precompute; 0 <= ref ? j <= ref : j >= ref; i = 0 <= ref ? ++j : --j) {
      progress = i * this$1._step;
      length = this$1.pathLength * progress;
      point = this$1.path.getPointAtLength(length);
      results.push(this$1._samples[i] = {
        point: point,
        length: length,
        progress: progress
      });
  ...
  PathEasing.prototype._findBounds = function (array, p) {
    ...
    for (i = j = ref = this._boundsStartIndex, ref1 = loopEnd; ref <= ref1 ? j < ref1 : j > ref1; i = ref <= ref1 ? ++j : --j) {
      value = array[i];
      pointX = value.point.x / this$1._rect;
      pointP = p;
...
var _sample = function _sample(fn) {
  ...
  var nType = typeof n === 'undefined' ? 'undefined' : _typeof(n);
...
var Easing = function () {
  ...
  Easing.prototype.parseEasing = function (easing) {
    ...
    type = typeof easing === 'undefined' ? 'undefined' : _typeof(easing);
    if (type === 'string') {
...
var Tween = function (_Module) {
  ...
  function Tween() {
    ...
    var _this = possibleConstructorReturn(this, (Tween.__proto__ || Object.getPrototypeOf(Tween)).call(this, o));
  ...
  createClass(Tween, [{
    ...
    */
    ...
    value: function _extendDefaults() {
      ...
      get(Tween.prototype.__proto__ || Object.getPrototypeOf(Tween.prototype), '_extendDefaults', this).call(this);
      ...
      if (onEdge && wasYoyo != null) {
        ...
        if (this._timelines) {
          for (var i = 0; i < this._timelines.length; i++) {
            this$1._timelines[i]._update(time, timelinePrevTime, wasYoyo, onEdge);
          }
        }
    ...
    */
    ...
    value: function _setProp(obj, value) {
      get(Tween.prototype.__proto__ || Object.getPrototypeOf(Tween.prototype), '_setProp', this).call(this, obj, value);
    ...
    */
    ...
    value: function _assignProp(key, value) {
      ...
      get(Tween.prototype.__proto__ || Object.getPrototypeOf(Tween.prototype), '_assignProp', this).call(this, key, value);
    }
    /*
...
var Timeline = function (_Tween) {
  ...
  createClass(Timeline, [{
    ...
    */
    ...
    value: function append() {
      ...
      for (var _len2 = arguments.length, timeline = Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {
        timeline[_key2] = arguments$1[_key2];
      }
      ...
      try {
        for (var _iterator = timeline[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          ...
          if (h.isArray(tm)) {
            this$1._appendTimelineArray(tm);
          } else {
            this$1._appendTimeline(tm, this$1._timelines.length);
          }
          this$1._calcDimentions();
        }
      } catch (err) {
    ...
    */
    ...
    key: 'stop',
    value: function stop(progress) {
      get(Timeline.prototype.__proto__ || Object.getPrototypeOf(Timeline.prototype), 'stop', this).call(this, progress);
    ...
    */
    ...
    key: 'reset',
    value: function reset() {
      get(Timeline.prototype.__proto__ || Object.getPrototypeOf(Timeline.prototype), 'reset', this).call(this);
      this._resetChildren();
      return this;
    }
    /*
    ...
    */
    ...
    value: function _stopChildren(progress) {
      ...
      for (var i = this._timelines.length - 1; i >= 0; i--) {
        this$1._timelines[i].stop(progress);
      }
    }
    /*
      Method to set tween's state to complete.
    ...
    */
    ...
    value: function _appendTimelineArray(timelineArray) {
      ...
      while (i--) {
        this$1._appendTimeline(timelineArray[i], len, time);
      }
    }
    /*
    ...
    */
    ...
    value: function _pushTimelineArray(array) {
      ...
      for (var i = 0; i < array.length; i++) {
        ...
        if (h.isArray(tm)) {
          this$1._pushTimelineArray(tm);
        } else {
          this$1._pushTimeline(tm);
        }
      };
    }
    /*
    ...
    */
    ...
    value: function _updateChildren(p, time, isYoyo) {
      ...
      for (var i = 0; i < len; i++) {
        ...
        this$1._timelines[j]._update(timeToTimelines, prevTimeToTimelines, this$1._prevYoyo, this$1._onEdge);
      }
    ...
    */
    ...
    value: function _setStartTime(time) {
      ...
      get(Timeline.prototype.__proto__ || Object.getPrototypeOf(Timeline.prototype), '_setStartTime', this).call(this, time);
    ...
    */
    ...
    value: function _refresh(isBefore) {
      ...
      for (var i = 0; i < len; i++) {
        this$1._timelines[i]._refresh(isBefore);
      }
      get(Timeline.prototype.__proto__ || Object.getPrototypeOf(Timeline.prototype), '_refresh', this).call(this, isBefore);
    }
    /*
    ...
    */
    ...
    value: function _declareDefaults() {
      ...
      get(Timeline.prototype.__proto__ || Object.getPrototypeOf(Timeline.prototype), '_declareDefaults', this).call(this);
      // remove default 
  ...
  function Timeline() {
    ...
    return possibleConstructorReturn(this, (Timeline.__proto__ || Object.getPrototypeOf(Timeline)).call(this, o));
  }
  /*
    Method to declare some vars.
    @private
  */
  ...
  createClass(Timeline, [{
    ...
    value: function _vars() {
      this._timelines = [];
      get(Timeline.prototype.__proto__ || Object.getPrototypeOf(Timeline.prototype), '_vars', this).call(this);
    }
  }]);
  return Timeline;
}(Tween);
...
var Tweenable = function (_Module) {
  inherits(Tweenable, _Module);
  createClass(Tweenable, [{
    key: 'play',
  ...
  function Tweenable() {
    var o = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    classCallCheck(this, Tweenable);

    // pipe function for _o object
    // before creating tween/timeline
    var _this = possibleConstructorReturn(this, (Tweenable.__proto__ || Object.getPrototypeOf(Tweenable)).call(this, o));
    // super of Module
...
var Thenable = function (_Tweenable) {
  inherits(Thenable, _Tweenable);

  function Thenable() {
    classCallCheck(this, Thenable);
    return possibleConstructorReturn(this, (Thenable.__proto__ || Object.getPrototypeOf(Thenable)).apply(this, arguments));
  }
  ...
  createClass(Thenable, [{
    ...
    */
    ...
    value: function _vars() {
      ...
      get(Thenable.prototype.__proto__ || Object.getPrototypeOf(Thenable.prototype), '_vars', this).call(this);
      // save _master module
      ...
      for (var key in this._arrayPropertyMap) {
        if (this$1._o[key]) {
          var preParsed = this$1._parsePreArrayProperty(key, this$1._o[key]);
    ...
    value: function _mergeEndLoop(o, start, end) {
      ...
      for (var key in end) {
        ...
        var endValue = end[key],
            startValue = start[key] != null ? start[key] : this$1._defaults[key];

        startValue = this$1._checkStartValue(key, startValue);
        if (endValue == null) {
          continue;
        };
        // make ∆ of start -> end
        ...
        o[key] = this$1._mergeThenProperty(key, startValue, endValue);
      }
    }
    /*
      ...
      if (!h.isTweenProp(key) && !this._nonMergeProps[key] && !isBoolean) {
        ...
        if (this._isDelta(endValue)) {
          ...
          if (this._isDelta(startValue)) {
            ...
            return _ref = {}, defineProperty(_ref, h.getDeltaEnd(startValue), parsedEndValue), defineProperty(_ref, 'easing', easing), defineProperty(_ref, 'curve', curve), _ref;
            // if both start and end value are not ∆ - make ∆
          } else {
            var _ref2;

            return _ref2 = {}, defineProperty(_ref2, startValue, parsedEndValue), defineProperty(_ref2, 'easing', easing), defineProperty(_ref2, 'curve', curve), _ref2;
          }
        }
...
var Tuneable = function (_Thenable) {
  inherits(Tuneable, _Thenable);

  function Tuneable() {
    classCallCheck(this, Tuneable);
    return possibleConstructorReturn(this, (Tuneable.__proto__ || Object.getPrototypeOf(Tuneable)).apply(this, arguments));
  }

  createClass(Tuneable, [{
    key: 'tune',
    ...
    */
    value: function tune(o) {
      ...
      if (o && Object.keys(o).length) {
        ...
        for (var key in this._arrayPropertyMap) {
          if (o[key] != null) {
            this$1._history[0][key] = this$1._preparsePropValue(key, o[key]);
          }
        }
    ...
    */
    ...
    value: function _transformHistory(o) {
      ...
      for (var key in o) {
        ...
        this$1._transformHistoryFor(key, this$1._preparsePropValue(key, value));
      }
    }
    /*
    ...
    */
    ...
    value: function _transformHistoryFor(key, value) {
      ...
      for (var i = 0; i < this._history.length; i++) {
        if (value = this$1._transformHistoryRecord(i, key, value)) {
    ...
    value: function _transformHistoryRecord(index, key, newVal, currRecord, nextRecord) {
      ...
      if (index === 0) {
        ...
        if (this._isDelta(oldVal)) {
          currRecord[key] = defineProperty({}, newVal, h.getDeltaEnd(oldVal));
          return null;
        } else {
    ...
    */
    ...
    value: function _tuneSubModules() {
      ...
      for (var i = 1; i < this._modules.length; i++) {
        this$1._modules[i]._tuneNewOptions(this$1._history[i]);
      }
    }
    /*
    ...
    */
    ...
    value: function _resetTweens() {
      ...
      for (var i = 0; i < tweens.length; i++) {
        ...
        this$1._resetTween(tween, this$1._history[i], shift);
      }
...
var Shape = function (_Tunable) {
  ...
  createClass(Shape, [{
    ...
    */
    ...
    key: 'tune',
    value: function tune(o) {
      get(Shape.prototype.__proto__ || Object.getPrototypeOf(Shape.prototype), 'tune', this).call(this, o);
    ...
    */
    ...
    value: function then(o) {
      // this._makeTimeline()
      get(Shape.prototype.__proto__ || Object.getPrototypeOf(Shape.prototype), 'then', this).call(this, o);
      // update shapeModule's size to the max in `then` chain
      this._getMaxSizeInChain();
      return this;
    }
    ...
    */
    ...
    value: function _vars() {
      ...
      get(Shape.prototype.__proto__ || Object.getPrototypeOf(Shape.prototype), '_vars', this).call(this);
      this._lastSet = {};
    ...
    */
    ...
    value: function _tuneNewOptions(o) {
      // call super on Module
      get(Shape.prototype.__proto__ || Object.getPrototypeOf(Shape.prototype), '_tuneNewOptions', this).call(this, o);
    ...
    */
    ...
    value: function _getMaxSizeInChain() {
      ...
      for (var i = 0; i < this._modules.length; i++) {
        this$1._modules[i]._getShapeSize();
        maxW = Math.max(maxW, this$1._modules[i]._props.shapeWidth);
        maxH = Math.max(maxH, this$1._modules[i]._props.shapeHeight);
      }
...
var ShapeSwirl = function (_Shape) {
  inherits(ShapeSwirl, _Shape);

  function ShapeSwirl() {
    classCallCheck(this, ShapeSwirl);
    return possibleConstructorReturn(this, (ShapeSwirl.__proto__ || Object.getPrototypeOf(ShapeSwirl)).apply(this, arguments));
  }

  createClass(ShapeSwirl, [{
    key: '_declareDefaults',
    ...
    */
    value: function _declareDefaults() {
      get(ShapeSwirl.prototype.__proto__ || Object.getPrototypeOf(ShapeSwirl.prototype), '_declareDefaults', this).call(this);
    ...
    */
    ...
    key: '_extendDefaults',
    value: function _extendDefaults() {
      get(ShapeSwirl.prototype.__proto__ || Object.getPrototypeOf(ShapeSwirl.prototype), '_extendDefaults', this).call(this);
      this._calcPosData();
    }
    /*
      Method to tune new oprions to _o and _props object.
    ...
    */
    ...
    value: function _tuneNewOptions(o) {
      ...
      get(ShapeSwirl.prototype.__proto__ || Object.getPrototypeOf(ShapeSwirl.prototype), '_tuneNewOptions', this).call(this, o);
...
var Burst = function (_Tunable) {
  inherits(Burst, _Tunable);

  function Burst() {
    classCallCheck(this, Burst);
    return possibleConstructorReturn(this, (Burst.__proto__ || Object.getPrototypeOf(Burst)).apply(this, arguments));
  }
  ...
  createClass(Burst, [{
    ...
    */
    ...
    value: function _extendDefaults() {
      ...
      get(Burst.prototype.__proto__ || Object.getPrototypeOf(Burst.prototype), '_extendDefaults', this).call(this);
    }
    /*
    ...
    value: function _recalcModulesTime() {
      ...
      for (var i = 0; i < modules.length; i++) {
        var tween = modules[i].tween,
            packTime = this$1._calcPackTime(swirls[i]);
    ...
    */
    ...
    value: function _tuneSwirls(o) {
      ...
      for (var i = 0; i < pack0.length; i++) {
        var swirl = pack0[i],
            option = this$1._getChildOption(o || {}, i);
        ...
        if (!isDegreeShift) {
          option.degreeShift = this$1._swirls[0][i]._props.degreeShift;
        }

        this$1._addBurstProperties(option, i);
        ...
        swirl.tune(option);
        this$1._refreshBurstOptions(swirl._modules, i);
      }
    }
    /*
    ...
    value: function _refreshBurstOptions(modules, i) {
      ...
      for (var j = 1; j < modules.length; j++) {
        var module = modules[j],
            options = {};
        this$1._addBurstProperties(options, i, j);
    ...
    */
    ...
    value: function _childThen(o) {
      ...
      for (var i = 0; i < pack.length; i++) {
        ...
        var options = this$1._getChildOption(o, i);
        var swirl = pack[i];
        var lastSwirl = h.getLastItem(swirl._modules);
        // add new Master Swirl as parent of new childswirl
        options.parent = this$1.el;

        this$1._addBurstProperties(options, i, this$1._masterSwirls.length - 1);
    ...
    */
    ...
    key: '_vars',
    value: function _vars() {
      get(Burst.prototype.__proto__ || Object.getPrototypeOf(Burst.prototype), '_vars', this).call(this);
    ...
    */
    ...
    value: function _renderSwirls() {
      ...
      for (var i = 0; i < p.count; i++) {
        var option = this$1._getChildOption(this$1._o, i);
        pack.push(new ChildSwirl(this$1._addOptionalProps(option, i)));
      }
      this._swirls = { 0: pack };
    ...
    */
    ...
    value: function _getChildOption(obj, i) {
      ...
      for (var key in obj.children) {
        options[key] = this$1._getPropByMod(key, i, obj.children);
      }
      return options;
    }
    /*
    ...
    */
    ...
    value: function _makeTimeline() {
      ...
      get(Burst.prototype.__proto__ || Object.getPrototypeOf(Burst.prototype), '_makeTimeline', this).call(this);
...
var ChildSwirl = function (_ShapeSwirl) {
  inherits(ChildSwirl, _ShapeSwirl);

  function ChildSwirl() {
    classCallCheck(this, ChildSwirl);
    return possibleConstructorReturn(this, (ChildSwirl.__proto__ || Object.getPrototypeOf(ChildSwirl)).apply(this, arguments));
  }

  createClass(ChildSwirl, [{
    key: '_declareDefaults',
    value: function _declareDefaults() {
      get(ChildSwirl.prototype.__proto__ || Object.getPrototypeOf(ChildSwirl.prototype), '_declareDefaults', this).call(this);
    ...
    value: function _calcSwirlXY(proc) {
      ...
      get(ChildSwirl.prototype.__proto__ || Object.getPrototypeOf(ChildSwirl.prototype), '_calcSwirlXY', this).call(this, proc);
...
var MainSwirl = function (_ChildSwirl) {
  inherits(MainSwirl, _ChildSwirl);

  function MainSwirl() {
    classCallCheck(this, MainSwirl);
    return possibleConstructorReturn(this, (MainSwirl.__proto__ || Object.getPrototypeOf(MainSwirl)).apply(this, arguments));
  }

  createClass(MainSwirl, [{
    key: '_declareDefaults',
    value: function _declareDefaults() {
      get(MainSwirl.prototype.__proto__ || Object.getPrototypeOf(MainSwirl.prototype), '_declareDefaults', this).call(this);
  ...
  createClass(Delta, [{
    ...
    value: function refresh(isBefore) {
      ...
      for (var i = 0; i < deltas.length; i++) {
        ...
        this$1._previousValues.push({
          name: name, value: this$1._o.props[name]
        });
      }
    ...
    */
    ...
    value: function restore() {
      ...
      for (var i = 0; i < prev.length; i++) {
        var record = prev[i];
        this$1._o.props[record.name] = record.value;
      }
      return this;
    }
    /*
    ...
    */
    ...
    value: function _calcCurrentProps(easedProgress, p) {
      ...
      for (var i = 0; i < deltas.length; i++) {
        ...
        this$1['_calcCurrent_' + type](deltas[i], easedProgress, p);
      }
    }
    /*
  ...
  createClass(Deltas, [{
    ...
    value: function refresh(isBefore) {
      ...
      for (var i = 0; i < this._deltas.length; i++) {
        this$1._deltas[i].refresh(isBefore);
      }
      return this;
    }
    /*
    ...
    */
    ...
    value: function _createDeltas() {
      ...
      for (var i = 0; i < this._childDeltas.length; i++) {
        var delta = this$1._childDeltas[i];
        this$1._deltas.push(this$1._createDelta([delta.delta], delta.tweenOptions));
      }
    }
    /*
    ...
    */
    ...
    value: function _parseDeltas(obj) {
      ...
      for (var i = 0; i < keys.length; i++) {
        ...
        if (this$1._isDelta(opts[key]) && !this$1._ignoreDeltasMap[key]) {
          var delta = this$1._splitAndParseDelta(key, opts[key]);
          // if parsed object has no tween values - it's delta of the main object
          if (!delta.tweenOptions) {
            this$1._mainDeltas.push(delta.delta);
          }
          // otherwise it is distinct delta object
          else {
              this$1._childDeltas.push(delta);
            }
        }
      }
    }
...
var Html = function (_Thenable) {
  ...
  createClass(Html, [{
    ...
    value: function then(o) {
      ...
      // call super
      get(Html.prototype.__proto__ || Object.getPrototypeOf(Html.prototype), 'then', this).call(this, o);
      // restore the _props
    ...
    */
    ...
    value: function _draw() {
      ...
      for (var i = 0; i < this._drawProps.length; i++) {
        var name = this$1._drawProps[i];
        this$1._setStyle(name, p[name]);
      }
      // draw transforms
      this._drawTransform();
    ...
    */
    ...
    value: function _render() {
      ...
      for (var i = 0; i < this._renderProps.length; i++) {
        var name = this$1._renderProps[i],
            value = p[name];

        value = typeof value === 'number' ? value + 'px' : value;
        this$1._setStyle(name, value);
      }
    ...
    */
    ...
    value: function _extendDefaults() {
      ...
      for (var i = 0; i < keys.length; i++) {
        ...
        var isInclude = !this$1._drawExclude[key] && // not in exclude map
        this$1._defaults[key] == null && // not transform property
        !TWEEN_PROPERTIES[key]; // not tween property

        var isCustom = this$1._customProps[key];
        ...
        if (!h.isDelta(o[key]) && !TWEEN_PROPERTIES[key]) {
          this$1._parseOption(key, o[key]);
          if (key === 'el') {
            this$1._props.el = h.parseEl(o.el);
            this$1.el = this$1._props.el;
          }
          if (isInclude && !isCustom) {
            this$1._renderProps.push(key);
          }
    ...
    */
    ...
    value: function _saveCustomProperties() {
      ...
      this._customProps = _extends({}, this._customProps);
    ...
    value: function _copyDefaultCustomProps() {
      ...
      for (var key in this._customProps) {
        if (this$1._o[key] == null) {
          this$1._o[key] = this$1._customProps[key];
        }
      }
    }
    /*
    ...
    */
    ...
    value: function _resetMergedFlags(o) {
      get(Html.prototype.__proto__ || Object.getPrototypeOf(Html.prototype), '_resetMergedFlags', this).call(this, o);
      o.props = this._props;
    ...
    */
    ...
    value: function _parseOption(key, value) {
      get(Html.prototype.__proto__ || Object.getPrototypeOf(Html.prototype), '_parseOption', this).call(this, key, value);
      ...
      for (var key in this._defaults) {
        ...
        if (obj[key] == null) {
          ...
          if (key === 'scaleX' || key === 'scaleY') {
            obj[key] = obj['scale'] != null ? obj['scale'] : this$1._defaults['scale'];
          } else {
            obj[key] = this$1._defaults[key];
          }
        } else {
          // get if 3d property was set.
          if (this$1._3dProperties.indexOf(key) !== -1) {
            this$1._is3d = true;
          }
        }
      }
    ...
    */
    ...
    value: function _vars() {
      ...
      // call super vars
      get(Html.prototype.__proto__ || Object.getPrototypeOf(Html.prototype), '_vars', this).call(this);
    ...
    */
    ...
    value: function _makeTimeline() {
      ...
      get(Html.prototype.__proto__ || Object.getPrototypeOf(Html.prototype), '_makeTimeline', this).call(this);
    ...
    value: function _mergeThenProperty(key, startValue, endValue) {
      ...
      if (!h.isTweenProp(key) && !this._nonMergeProps[key] && !isBoolean) {
        ...
        if (this._isDelta(endValue)) {
          ...
          return _extends({}, result, _TWEEN_PROPS);
        } else {
          var parsedEndValue = this._parsePreArrayProperty(key, endValue);
          // if end value is not delta - merge with start value
          if (this._isDelta(startValue)) {
            // if start value is delta - take the end value
            // as start value of the new delta
            return _extends(defineProperty({}, h.getDeltaEnd(startValue), parsedEndValue), TWEEN_PROPS);
            // if both start and end value are not ∆ - make ∆
          } else {
            return _extends(defineProperty({}, startValue, parsedEndValue), TWEEN_PROPS);
          }
        }
        // copy the tween values unattended
      } else {
...
var Stagger = function (_Tunable) {
  ...
  function Stagger(options, Module) {
    ...
    var _this = possibleConstructorReturn(this, (Stagger.__proto__ || Object.getPrototypeOf(Stagger)).call(this));

    return _ret = _this._init(options, Module), possibleConstructorReturn(_this, _ret);
  }
  /*
  ...
  createClass(Stagger, [{
    ...
    value: function then(o) {
      ...
      for (var i = 0; i < this._modules.length; i++) {
        ...
        this$1._modules[i].then(this$1._getOptionByIndex(i, o));
      }
      this.timeline._recalcTotalDuration();
      return this;
    }
    ...
    */
    ...
    value: function tune(o) {
      ...
      for (var i = 0; i < this._modules.length; i++) {
        // get child module's option and pass to the child `then`
        this$1._modules[i].tune(this$1._getOptionByIndex(i, o));
      }
      this.timeline._recalcTotalDuration();
      return this;
    }
    ...
    */
    ...
    value: function _init(options, Module) {
      ...
      for (var i = 0; i < count; i++) {
        ...
        var option = this$1._getOptionByIndex(i, options);
        option.isRunLess = true;
        // set index of the module
        option.index = i;
        // create child module
        var module = new Module(option);this$1._modules.push(module);
        // add child module's timeline to the self timeline
        this$1.timeline.add(module);
      }
      return this;
    }
    /*
...
var MotionPath = function () {
  ...
  MotionPath.prototype.extendOptions = function (o) {
    ...
    for (key in o) {
      value = o[key];
      results.push(this$1.props[key] = value);
    }
    return results;
  };
